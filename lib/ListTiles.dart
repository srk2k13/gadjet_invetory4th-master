...
import 'package:gadjet_invetory/Form/DetailView.dart';


import 'package:gadjet_invetory/Form/UploadData.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        /*  IconButton(icon: Icon(Icons.arrow_back, size: 36, color: Colors.white,),
            onPressed: () {
