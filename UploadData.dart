...
import 'package:gadjet_invetory/Form/ListTiles.dart';
import 'package:gadjet_invetory/main.dart';
...
var _todoDateController = TextEditingController();
 ...
 _selectedtodoDate(BuildContext context) async {
  ...
  String devicetype,cattegorrytype,companyname,modelname ,seriesname,year,serielnumber,warrantydate,servicecentredetails,name,mobilenumber,address,website ;
  ...
  final firebase_storage.Reference _reference  = firebase_storage.FirebaseStorage.instance
      .ref().child('DeviceImages/DeviceImage${DateTime.now()}.jpg');

  final firebase_storage.Reference _reference2  = firebase_storage.FirebaseStorage.instance
      .ref().child('WCImages/WCImage${DateTime.now()}.jpg');
  final firebase_storage.Reference _reference3  = firebase_storage.FirebaseStorage.instance
      .ref().child('UGImages/UGImage${DateTime.now()}.jpg');
  final firebase_storage.Reference _storagepdf1reference = FirebaseStorage.instance.ref().child("DeviceDocs/DeviceDoc${DateTime.now()}.pdf");
  final firebase_storage.Reference _storagepdf2reference = FirebaseStorage.instance.ref().child("DeviceDocs/DeviceDoc${DateTime.now()}.pdf");
  ...
  Future <void> getWCImage(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image2  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image2  != null) {
        setState(() {
          imageFile2 = image2;
  ...
  getCamWCImage(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image2  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image2  != null) {
        setState(() {
  ...
  Future <void> getUGImage(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image3  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image3  != null) {
        setState(() {
          imageFile3 = image3;
  ...
  getCamUGImage(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image3  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image3  != null) {
        setState(() {
...
/*  _showImage4() {
                        ...
                        child: Padding(
                          ...
                          child: Theme(
                            ...
                            child: TextFormField(
                              validator: (value){
                                if(value.isEmpty){
                                  return "Please write the Service Centre Details of production";
                                }else {
                                  servicecentredetails = value;
                                }
                              },
                              ...
                              autofocus: false,
                              decoration: InputDecoration(
                                labelText: ' Service Centre Details  ',
                                hintText: 'Enter the Service Centre Details',
                              ),
                              maxLength: 15,
  ...
  Future <void> openGallery(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image1  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image1  != null) {
        setState(() {
          imageFile = image1;
  ...
  openCamera(BuildContext context, ImageSource source) async {
    if (source != null) {
      final image1  = await ImagePicker.pickImage(source: source,  maxHeight: 1920, maxWidth: 1080);
      if (image1  != null) {
        setState(() {
  ...
  Future<void> upload() async{
    if(formKey.currentState.validate()) {
      ...
      String PDFPath = 'DeviceDocs/DeviceDocs${DateTime.now()}.pdf';
      final firebase_storage.Reference  _storagepdf1reference   = FirebaseStorage.instance.ref().child(PDFPath);



      firebase_storage.UploadTask uploadTask4 = _storagepdf1reference.putFile(PDfFile1);
      firebase_storage.TaskSnapshot downloadPDFUrl = (await uploadTask4);
   //   String pdf1url = (await downloadPDFUrl.ref.getDownloadURL());


      var wcpdfUrl = await (await uploadTask4).ref.getDownloadURL();
      String pdf1url = wcpdfUrl.toString();




      String PDF2Path = 'DeviceDocs/DeviceDocs${DateTime.now()}.pdf';
      final firebase_storage.Reference  _storagepdf2reference   = FirebaseStorage.instance.ref().child(PDF2Path);



      firebase_storage.UploadTask uploadTask5 = _storagepdf2reference.putFile(PDfFile2);
      firebase_storage.TaskSnapshot downloadPDFUrl2 = (await uploadTask5);
      var ugpdfUrl = await (await uploadTask5).ref.getDownloadURL();
      ...
      final firebase_storage.Reference  _reference3    = FirebaseStorage.instance.ref().child(UGImagesPath);

      firebase_storage.UploadTask uploadTask3 = _reference3.putFile(imageFile2);

      var ugimgUrl = await (await uploadTask3).ref.getDownloadURL();
      ...
      final firebase_storage.Reference  _reference2    = FirebaseStorage.instance.ref().child(WCImagesPath);
     ...
     /* StorageReference _reference3 = FirebaseStorage.instance.ref().child(
      ...
      firebase_storage.UploadTask uploadTask2 = _reference2.putFile(imageFile3);

      var wcimgUrl = await (await uploadTask3).ref.getDownloadURL();
      String wcurl = wcimgUrl.toString();


      String ImagesPath = 'DeviceImages/DeviceImage${DateTime.now()}.jpg';
      final firebase_storage.Reference  reference    = FirebaseStorage.instance.ref().child(ImagesPath);
      ...
      map ["servicecentredetails"] = servicecentredetails;
      map ["name"] = name;
